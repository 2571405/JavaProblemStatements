...
private void addCompanyEmpWage(String compName, int numOfDays, int empRate, int maxHrs){
	companyEmpWageArray[numOfCompany] = new CompanyEmpWage(compName, numOfDays, empRate, maxHrs);
	numOfCompany++;
}
	/*
